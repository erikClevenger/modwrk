...
<html lang="en">
	...
	<section>
		<h2>Welcome &amp; About</h2>
		<p>The first section of this site will act as a brief welcome and about me. In particular this is where I
			would like to have a button view my resume and c.v. As the intention of this
			website is to essentially attract potential work I want necessary information readily accessible. </p>
		<p>As far as the overall design goals go the focus of this site will be to make sure that it is very
			clean with next to no "buttons" visible while also making it very clear that there are other places to
			navigate to. I'm shooting for a mostly horizontal feeling layout.</p>
	</section>
	<section>
		<h2>Portfolio</h2>
	...
	<section class="wireframes">
		<div class="mobile">
			<img class="mobile" src="../images/mb-welcomeAbout.png" alt="mobile splash screen wireframe">
			<img class="mobile" src="../images/mb-contact.png" alt="mobile contact wireframe ">
			<img class="mobile" src="../images/mb-portfolio.png" alt="mobile portfolio wireframe">
			<img class="mobile" src="../images/mb-portfolioItem.png" alt="mobile portfolio item wireframe">
		...
		<div class="desktop">
			...
			<img class="desktop" src="../images/dsk-contact.png" alt=" desktop contact wireframe">
			<img class="desktop" src="../images/dsk-portfolio.png" alt=" desktop portfolio wireframe">
			<img class="desktop" src="../images/dsk-portfolioItem.png" alt=" desktop portfolio-item wireframe">
		</div>
