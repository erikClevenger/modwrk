...
<div class="container smallHide animated fadeInDown">
	<ul id="menu" class="nav justify-content-center">
		...
		<li class="nav-item">
			<a class="nav-link animsition-link" href="<?php echo $PREFIX; ?>php/contact">Contact</a>
		</li>
		<li class="nav-item">
			<a class="nav-link animsition-link" href="<?php echo $PREFIX; ?>php/portfolio">Portfolio</a>
		</li>
		<li class="nav-item">
...
<div class="container bigHide fixed-bottom">
	<div class="collapse " id="btmNavToggle">
		<div class="d-flex flex-row mb-3 justify-content-around" aria-label="navigation">
			<a href="#" role="button" class="btn backWhite" >Home</a>
			<a href="<?php echo $PREFIX; ?>contact" role="button" class="btn backWhite animsition-link" >Contact</a>
			<a href="<?php echo $PREFIX; ?>portfolio" role="button" class="btn backWhite animsition-link">Portfolio</a>
		</div>
	</div>
